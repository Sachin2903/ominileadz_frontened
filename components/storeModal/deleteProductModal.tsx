...
export function DeleteProductModal({deleteModalOpen,setDeleteModalOpen,BulkActionArray,refresh,setRefresh,setPreFilledData}:any){
  const [deleteLoading,setDeleteLoading]=useState(false)
   ...
   async function handleOk(){
       try {
        ...
        const response=await axios.delete(`${process.env.NEXT_PUBLIC_BASE_URL}/products/deletemanyproducts`,{data:body})
