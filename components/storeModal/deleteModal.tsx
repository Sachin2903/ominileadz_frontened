...
export function DeleteModal({deleteModalOpen,setDeleteModalOpen,BulkActionArray,refresh,setRefresh,setPreFilledProduct}:any){
  const [deleteLoading,setDeleteLoading]=useState(false)
   ...
   async function handleOk(){
       try {
        ...
        const response=await axios.delete(`${process.env.NEXT_PUBLIC_BASE_URL}/attribute/deletemany`,{data:body})
