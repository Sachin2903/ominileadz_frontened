"use client"
import { Button, Input, message, MenuProps, Dropdown, Upload, UploadProps, UploadFile } from 'antd';
...
export default function TopLayer({ fileList, setFileList, openAddTribute, setOpenAddAttribute, setDeleteModalOpen, setBulkActionDrawer, BulkActionArray, setBulkActionArray }: any) {
    ...
    return (
        <div className="min-w-0  flex-wrap bg-white flex  justify-between items-center p-2 pt-6 mt-4 shadow-lg  rounded-md  mb-5">
            ...
            <section className='sm:w-fit w-full mb-3 flex sm:flex-row flex-col gap-2'>
                ...
                <Button onClick={() => setOpenAddAttribute(true)} type="primary" className="sm:w-fit w-full bg-blue-500 " size="large" >
                    +   Add Attribute
                </Button>
            </section>
        </div>
